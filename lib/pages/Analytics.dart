                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        DropdownButton<String>(
                                          ...
                                          hint: Text(
                                              'Выберите ценную бумагу'), // Initial hint text
                                        ...
                                        if (_selectedTicker.isNotEmpty)
                                          FutureBuilder<double>(
                                            future: fetchSecurityPrice(
                                                _selectedTicker),
                                            builder: (context, snapshot) {
                                              if (snapshot.hasData) {
                                                final selectedPrice =
                                                    snapshot.data!;
                                                final selectedSecurityDocument =
                                                    securitiesSnapshot.docs
                                                        .firstWhere(
                                                  (document) =>
                                                      document['ticker'] ==
                                                      _selectedTicker,
