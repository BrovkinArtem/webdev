        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage(illustration4),
              fit: BoxFit.contain)),
          ),
          SizedBox(
            height: 20,),
                  ...
                  children: [
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          const url = 'https://web.telegram.org/k/#@AveragingInvestor_bot';
                    ...
                    SizedBox(width: 20),
                    Text('— Same functionality, different platform', style: TextStyle(color: Colors.grey.shade400, fontSize: 20))
                  ],
                )
              ],
            ),
